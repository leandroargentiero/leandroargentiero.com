...
export const Footer = () => {
  ...
  return (
    <footer className="p-5">
      <div className="rounded-2xl bg-gray-100 md:px-12 md:pb-12 md:pt-24">
        <Container>
          <div className="">
            <div className="grid grid-cols-1 md:mb-16 md:grid-cols-2">
              <div className="flex flex-col justify-between font-display">
                <div className="mb-8">
                  ...
                  <p className="font-body text-gray-400">
                    ...
                    Feel free to reach out if you&apos;ve a question, or just
                    want to connect.
                  </p>
                </div>
                <a
