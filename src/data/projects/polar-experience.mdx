...
record-holding polar traveler (who sadly passed away during during an expedition
in Greenland), and Julie Brown that offers tailored polar expeditions and polar
training. They approached me to help them with a rebranding of their existing
Polar Circles and Polar Experience brands.
...
<Image
  alt={`New website`}
  src={`/static/projects/polar-experience/cover.jpg`}
  blurDataURL={`/static/projects/polar-experience/cover.jpg`}
  priority
/>

## Useful links

[Visit website](https://www.polarexperience.com)
